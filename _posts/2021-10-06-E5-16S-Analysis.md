...
Created in R and scp to bluewaves folder
...
cd /data/putnamlab/estrand/HoloInt_16s/raw_files
...
cd /data/putnamlab/estrand/HoloInt_16s/processed_data

# Metadata path
METADATA="../metadata/16S_E5_Metadata.txt"
